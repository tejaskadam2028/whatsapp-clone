...
import com.example.whatsappclone.presentation.splashscreen.updatescreen.ChannelDesignItem
...
fun CommunitesScreen() {
    ...
    var sampleCommunity = listOf(
        Communites(image = R.drawable.img,name="Tech Enthusiats", memberCount = "256 member"),
        Communites(image = R.drawable.img,name="Photography lover", memberCount = "156 member"),
        Communites(image = R.drawable.img,name="Traveller", memberCount = "120 member")
        ...
        Column(modifier = Modifier.padding(it)) {
            ...
            LazyColumn {
                items(sampleCommunity){
                    CommunityDesignItem(communites = it)
                }
            }
