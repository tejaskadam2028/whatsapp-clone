package com.example.whatsappclone.presentation.splashscreen.viewmodel
...
import com.example.whatsappclone.presentation.splashscreen.updatescreen.statusdata
...
class PhoneAuthViewModel @Inject constructor(
    ...
    private fun fetchUserProfile(userId:String){
        ...
        val userNodeRef=userRef.child(userId)
        userNodeRef.get().addOnCompleteListener{ snapshot->

            if(snapshot.result.exists()){

                val userProfile =snapshot.result.getValue(phoneAuthUser::class.java)
    ...
    fun saveUserProfile(userId: String,name:String,state:String,profileImage: Bitmap?){
